...
print("")
print ("Percentage of ones rolled: " + str(((ones) / (rollNumber))*100) + " %")
print ("Percentage of twos rolled: " + str(((twos) / (rollNumber))*100) + " %")
print ("Percentage of threes rolled: " + str(((threes) / (rollNumber))*100) + " %")
print ("Percentage of fours rolled: " + str(((fours) / (rollNumber))*100) + " %")
print ("Percentage of five rolled: " + str(((fives) / (rollNumber))*100) + " %")
print ("Percentage of sixes rolled: " + str(((sixes) / (rollNumber))*100) + " %")
